<template>
  ...
  >
    ...
    <p class="text-gray-700 dark:text-slate-300 mb-2">Drag & drop files here (max 10)</p>
    <p class="text-sm text-gray-500 dark:text-slate-500">or click to browse &bull; 500 MB total limit</p>
